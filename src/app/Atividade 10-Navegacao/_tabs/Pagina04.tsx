...
export default function PaginaMatrix() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.banner, { borderColor: '#22C55E' }]}>
          ...
          <View style={[styles.bannerGlow, { backgroundColor: 'rgba(34,197,94,0.10)' }]} />
        </View>

        {/* Badge gênero */}
        <View style={[styles.genreBadge, { backgroundColor: '#22C55E' }]}>
          <Text style={styles.genreText}>FICÇÃO CIENTÍFICA / AÇÃO</Text>
        </View>

        <Text style={styles.titulo}>Matrix</Text>

        <View style={styles.metaRow}>
          <View style={styles.metaTag}><Text style={styles.metaTagText}>📅 1999</Text></View>
          <View style={styles.metaTag}><Text style={styles.metaTagText}>⏱ 2h 16min</Text></View>
        ...
        <Text style={styles.sectionContent}>Lilly & Lana Wachowski</Text>

        <Text style={styles.sectionLabel}>🎭 Elenco Principal</Text>
        <Text style={styles.sectionContent}>Keanu Reeves · Laurence Fishburne · Carrie-Anne Moss · Hugo Weaving</Text>

        <Text style={styles.sectionLabel}>📖 Sinopse</Text>
        <Text style={styles.sinopse}>
          Thomas Anderson, um programador que usa o codinome Neo, descobre que a realidade que
          conhece é uma simulação computacional criada por máquinas para subjugar a humanidade.
          Guiado pelo misterioso Morpheus e por Trinity, ele embarca na luta para libertar o mundo.
        </Text>

        <Text style={styles.sectionLabel}>🏆 Prêmios</Text>
        <Text style={styles.sectionContent}>Oscar 2000 — Melhores Efeitos Visuais, Edição, Edição de Som e Mixagem de Som</Text>
...
const styles = StyleSheet.create({
  ...
  banner: {
    ...
    backgroundColor: '#031A0A', justifyContent: 'center', alignItems: 'center',
