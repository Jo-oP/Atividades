...
export default function PaginaCidadeDeDeus() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Banner */}
        <View style={[styles.banner, { borderColor: '#F97316' }]}>
          <Text style={styles.bannerEmoji}>📸</Text>
          <View style={[styles.bannerGlow, { backgroundColor: 'rgba(249,115,22,0.10)' }]} />
        </View>

        {/* Badge gênero */}
        <View style={[styles.genreBadge, { backgroundColor: '#F97316' }]}>
          <Text style={styles.genreText}>CRIME / DRAMA</Text>
        </View>

        <Text style={styles.titulo}>Cidade de Deus</Text>

        <View style={styles.metaRow}>
          <View style={styles.metaTag}><Text style={styles.metaTagText}>📅 2002</Text></View>
          <View style={styles.metaTag}><Text style={styles.metaTagText}>⏱ 2h 10min</Text></View>
          <View style={styles.metaTag}><Text style={styles.metaTagText}>🌍 Brasil</Text></View>
        </View>
        ...
        <View style={[styles.notaBox, { borderColor: '#F59E0B' }]}>
          ...
          <View>
            ...
            <Text style={styles.notaValor}>8.7 / 10</Text>
          </View>
        </View>
        ...
        <Text style={styles.sectionContent}>Fernando Meirelles & Kátia Lund</Text>

        <Text style={styles.sectionLabel}>🎭 Elenco Principal</Text>
        <Text style={styles.sectionContent}>Alexandre Rodrigues · Leandro Firmino · Phellipe Haagensen</Text>

        <Text style={styles.sectionLabel}>📖 Sinopse</Text>
        <Text style={styles.sinopse}>
          Na favela Cidade de Deus, no subúrbio do Rio de Janeiro, dois jovens trilham caminhos
          opostos: Buscapé sonha em se tornar fotógrafo, enquanto Zé Pequeno ascende como o
          traficante mais violento e temido da região. Um retrato brutal e poético da desigualdade.
        </Text>

        <Text style={styles.sectionLabel}>🏆 Prêmios</Text>
        <Text style={styles.sectionContent}>4 indicações ao Oscar 2004 · BAFTA Melhor Filme Estrangeiro</Text>
...
const styles = StyleSheet.create({
  ...
  banner: {
    ...
    backgroundColor: '#1C1000', justifyContent: 'center', alignItems: 'center',
